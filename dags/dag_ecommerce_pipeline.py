...
with DAG(
    ...
    # Modelagem de Dimensão Fornecedor
    modeling_dim_fornecedor = SparkSubmitOperator(
        task_id="modeling_dim_fornecedor_to_gold",
        application=f"{JOBS_BASE_PATH}/modeling/modeling_dim_fornecedor.py",
        conn_id=SPARK_CONN_ID,
        verbose=True
    )

    # Modelagem de Fato Vendas
    modeling_fato_vendas = SparkSubmitOperator(
        task_id="modeling_fato_vendas_to_gold",
        application=f"{JOBS_BASE_PATH}/modeling/modeling_fato_vendas.py",
        conn_id=SPARK_CONN_ID,
        verbose=True
    )
    ...
    # Modelagem de Fato Estoque
    modeling_fato_estoque = SparkSubmitOperator(
        task_id="modeling_fato_estoque_to_gold",
        application=f"{JOBS_BASE_PATH}/modeling/modeling_fato_estoque.py",
        conn_id=SPARK_CONN_ID,
        verbose=True
    )
